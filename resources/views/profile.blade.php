...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('Perfil de Usuario') }}</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center">
                                ...
                                <p>{{getRol(Auth::user()->user_type_id_user_type)}}</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="name">Nombre de Usuario<span class="small text-danger">*</span></label>
                                        <input type="text" id="name" class="form-control" name="name" placeholder="Nombre de Usuario" value="{{ old('name', Auth::user()->username) }}">
                                    </div>
                                </div>
                            </div>
